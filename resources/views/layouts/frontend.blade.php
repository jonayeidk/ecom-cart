...
<head>
        ...
        <link rel="stylesheet" href="{{ asset('assets/frontend')}}/assets/css/chosen.min.css">
        <link rel="stylesheet" href="{{ asset('assets/frontend')}}/assets/css/icofont.css">
        ...
        <link rel="stylesheet" href="{{ asset('assets/frontend')}}/assets/css/bundle.css">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="logo-small-device">
                                    <a href="index.html"><img alt="" src="{{ asset('assets/frontend')}}/assets/img/logo/logo.png"></a>
                                </div>
                            </div>
                                ...
                                <div class="header-contact-menu-wrapper pl-45">
                                    ...
                                    <div class="menu-wrapper text-center">
                                        <button class="menu-toggle">
                                            <img class="s-open" alt="" src="{{ asset('assets/frontend')}}/assets/img/icon-img/menu.png">
                                            <img class="s-close" alt="" src="{{ asset('assets/frontend')}}/assets/img/icon-img/menu-close.png">
                                        </button>
                                        <div class="main-menu">
                                            <nav>
                                                <ul>
                                        ...
                                        <ul>
                                            <li class="single-shopping-cart">
                                                <div class="shopping-cart-img">
                                                    <a href="#"><img alt="" src="{{ asset('assets/frontend')}}/assets/img/cart/cart-1.jpg"></a>
                                                </div>
                                            ...
                                            <li class="single-shopping-cart">
                                                <div class="shopping-cart-img">
                                                    <a href="#"><img alt="" src="{{ asset('assets/frontend')}}/assets/img/cart/cart-2.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                            ...
                                            <li class="single-shopping-cart">
                                                <div class="shopping-cart-img">
                                                    <a href="#"><img alt="" src="{{ asset('assets/frontend')}}/assets/img/cart/cart-3.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h3><a href="#">Demonissi Gori</a></h3>
                                                    <span>Price: $275</span>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="footer-widget mb-30">
                                    <div class="footer-logo">
                                        <a href="index.html">
                                            <img src="{{ asset('assets/frontend')}}/assets/img/logo/2.png" alt="">
                                        </a>
                                    </div>
...
10 min ago</p>
                            ...
                            <div class="qwick-view-left">
                                ...
                                <div class="quick-view-list nav" role="tablist">
                                    <a class="active" href="#modal1" data-toggle="tab" role="tab">
                                        <img src="{{ asset('assets/frontend')}}/assets/img/quick-view/s1.jpg" alt="">
                                    </a>
                                    <a href="#modal2" data-toggle="tab" role="tab">
                                        <img src="{{ asset('assets/frontend')}}/assets/img/quick-view/s2.jpg" alt="">
                                    </a>
                                    <a href="#modal3" data-toggle="tab" role="tab">
                                        <img src="{{ asset('assets/frontend')}}/assets/img/quick-view/s3.jpg" alt="">
                                    </a>
                                </div>
                            </div>
		...
		<!-- all js here -->
        <script src="{{ asset('assets/frontend/')}}/assets/js/vendor/jquery-1.12.0.min.js"></script>
        <script src="{{ asset('assets/frontend/')}}/assets/js/popper.js"></script>
        ...
        <script src="{{ asset('assets/frontend/')}}/assets/js/ajax-mail.js"></script>
