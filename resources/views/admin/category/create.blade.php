          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <a href="{{route('admin.category.index')}}" class="card-link float-right">Manage New</a>
              </div>
            </div>
                        ...
                        <form class="form-horizontal" method="post" action="{{route('admin.category.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" id="title" class="form-control col-md-12 col-xs-12" name="title" placeholder="Category Name" required/>
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="col-md-12 col-sm-12 col-xs-12" for="parent category"> Parent
                                </label>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <select class="form-control col-md-12 col-xs-12" name="parent" required>
                            ...
                            <div class="item form-group">
                                <label class="col-md-12 col-sm-12 col-xs-12" for="status"> Status <span class="text-danger">*</span>
                                </label>
                                <div class="col-md-12 col-sm-12 col-xs-12">
